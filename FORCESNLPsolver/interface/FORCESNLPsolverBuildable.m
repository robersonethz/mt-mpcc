...
classdef FORCESNLPsolverBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function [output,exitflag,info] = forcesInitOutputsMatlab()
            ...
            outputs_x21 = coder.nullcopy(zeros(12, 1));
            outputs_x22 = coder.nullcopy(zeros(12, 1));
            outputs_x23 = coder.nullcopy(zeros(12, 1));
            outputs_x24 = coder.nullcopy(zeros(12, 1));
            outputs_x25 = coder.nullcopy(zeros(12, 1));
            outputs_x26 = coder.nullcopy(zeros(12, 1));
            outputs_x27 = coder.nullcopy(zeros(12, 1));
            outputs_x28 = coder.nullcopy(zeros(12, 1));
            outputs_x29 = coder.nullcopy(zeros(12, 1));
            outputs_x30 = coder.nullcopy(zeros(12, 1));
            outputs_x31 = coder.nullcopy(zeros(12, 1));
            outputs_x32 = coder.nullcopy(zeros(12, 1));
            outputs_x33 = coder.nullcopy(zeros(12, 1));
            outputs_x34 = coder.nullcopy(zeros(12, 1));
            outputs_x35 = coder.nullcopy(zeros(12, 1));
            outputs_x36 = coder.nullcopy(zeros(12, 1));
            outputs_x37 = coder.nullcopy(zeros(12, 1));
            outputs_x38 = coder.nullcopy(zeros(12, 1));
            outputs_x39 = coder.nullcopy(zeros(12, 1));
            outputs_x40 = coder.nullcopy(zeros(12, 1));
    ...
    methods (Static, Access = private)
        function [output,exitflag,info] = forcesInitOutputsC()
            ...
            outputs_x21 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x22 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x23 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x24 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x25 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x26 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x27 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x28 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x29 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x30 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x31 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x32 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x33 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x34 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x35 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x36 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x37 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x38 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x39 = coder.nullcopy(double(zeros(12, 1)));
            outputs_x40 = coder.nullcopy(double(zeros(12, 1)));
            output = struct('x01', outputs_x01,...
                            'x02', outputs_x02,...
                            'x03', outputs_x03,...
                            'x04', outputs_x04,...
