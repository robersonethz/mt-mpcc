...
a Python wrapper for a fast solver generated by FORCESPRO v6.1.0
   ...
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['x0'] - matrix of size [1120x1]
   ...
   OUTPUT returns the values of the last iteration of the solver where
       OUTPUT['x01'] - column vector of length 28
       OUTPUT['x02'] - column vector of length 28
       OUTPUT['x03'] - column vector of length 28
       OUTPUT['x04'] - column vector of length 28
       OUTPUT['x05'] - column vector of length 28
       OUTPUT['x06'] - column vector of length 28
       OUTPUT['x07'] - column vector of length 28
       OUTPUT['x08'] - column vector of length 28
       OUTPUT['x09'] - column vector of length 28
       OUTPUT['x10'] - column vector of length 28
       OUTPUT['x11'] - column vector of length 28
       OUTPUT['x12'] - column vector of length 28
       OUTPUT['x13'] - column vector of length 28
       OUTPUT['x14'] - column vector of length 28
       OUTPUT['x15'] - column vector of length 28
       OUTPUT['x16'] - column vector of length 28
       OUTPUT['x17'] - column vector of length 28
       OUTPUT['x18'] - column vector of length 28
       OUTPUT['x19'] - column vector of length 28
       OUTPUT['x20'] - column vector of length 28
       OUTPUT['x21'] - column vector of length 28
       OUTPUT['x22'] - column vector of length 28
       OUTPUT['x23'] - column vector of length 28
       OUTPUT['x24'] - column vector of length 28
       OUTPUT['x25'] - column vector of length 28
       OUTPUT['x26'] - column vector of length 28
       OUTPUT['x27'] - column vector of length 28
       OUTPUT['x28'] - column vector of length 28
       OUTPUT['x29'] - column vector of length 28
       OUTPUT['x30'] - column vector of length 28
       OUTPUT['x31'] - column vector of length 28
       OUTPUT['x32'] - column vector of length 28
       OUTPUT['x33'] - column vector of length 28
       OUTPUT['x34'] - column vector of length 28
       OUTPUT['x35'] - column vector of length 28
       OUTPUT['x36'] - column vector of length 28
       OUTPUT['x37'] - column vector of length 28
       OUTPUT['x38'] - column vector of length 28
       OUTPUT['x39'] - column vector of length 28
       OUTPUT['x40'] - column vector of length 28
...
('x0', ctypes.c_double * 1120),
('all_parameters', ctypes.c_double * 1360),
...
#    def from_param(self):
#        return self
    _fields_ = [('x01', ctypes.c_double * 28),
('x02', ctypes.c_double * 28),
('x03', ctypes.c_double * 28),
('x04', ctypes.c_double * 28),
('x05', ctypes.c_double * 28),
('x06', ctypes.c_double * 28),
('x07', ctypes.c_double * 28),
('x08', ctypes.c_double * 28),
('x09', ctypes.c_double * 28),
('x10', ctypes.c_double * 28),
('x11', ctypes.c_double * 28),
('x12', ctypes.c_double * 28),
('x13', ctypes.c_double * 28),
('x14', ctypes.c_double * 28),
('x15', ctypes.c_double * 28),
('x16', ctypes.c_double * 28),
('x17', ctypes.c_double * 28),
('x18', ctypes.c_double * 28),
('x19', ctypes.c_double * 28),
('x20', ctypes.c_double * 28),
('x21', ctypes.c_double * 28),
('x22', ctypes.c_double * 28),
('x23', ctypes.c_double * 28),
('x24', ctypes.c_double * 28),
('x25', ctypes.c_double * 28),
('x26', ctypes.c_double * 28),
('x27', ctypes.c_double * 28),
('x28', ctypes.c_double * 28),
('x29', ctypes.c_double * 28),
('x30', ctypes.c_double * 28),
('x31', ctypes.c_double * 28),
('x32', ctypes.c_double * 28),
('x33', ctypes.c_double * 28),
('x34', ctypes.c_double * 28),
('x35', ctypes.c_double * 28),
('x36', ctypes.c_double * 28),
('x37', ctypes.c_double * 28),
('x38', ctypes.c_double * 28),
('x39', ctypes.c_double * 28),
('x40', ctypes.c_double * 28),
]
