...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 1 */
    ssSetInputPortMatrixDimensions(S,  1, 520, 1);
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 1040, 1);
